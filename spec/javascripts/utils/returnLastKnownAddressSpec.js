...
describe('returnLastKnownAddress', () => {
  ...
  it('returns null when addresses doesnot have effective start date', () => {
    const addresses = Immutable.fromJS([
      {
        zip: '34567',
        city: 'San Francisco',
    ...
    expect(returnLastKnownAddress(addresses)).toEqual(null)
  })

  it('returns null when one address doesnot have effective start date', () => {
    const addresses = Immutable.fromJS([
      {
        zip: '34567',
        city: 'San Francisco',
  ...
  it('return null when empty List is passed', () => {
    expect(returnLastKnownAddress(List())).toEqual(null)
  })
})
