    ...
    it('returns formatted people object map', () => {
      ...
      expect(getPeopleWithEditsSelector(state)).toEqualImmutable(fromJS({
        one: {
          ...
          addresses: [
            {id: 'ABC', street_address: '1234 Nowhere Lane', city: 'Somewhereville', state: 'CA', zip: '55555', type: 'Home', legacy_id: 'A2', legacy_descriptor: {legacy_id: 'A2'}},
            {id: null, street_address: '9674 Somewhere Street', city: 'Nowhereville', state: 'CA', zip: '55555', type: 'Cell', legacy_id: undefined, legacy_descriptor: undefined},
          ],
          roles: ['a', 'b'],
          ssn: '321456789',
          sensitive: true,
        ...
        two: {
          ...
          addresses: [{id: null, street_address: null, city: null, state: null, zip: null, type: null, legacy_id: undefined, legacy_descriptor: undefined}],
          roles: ['c'],
          ssn: '321456789',
          sensitive: false,
          sealed: false,
