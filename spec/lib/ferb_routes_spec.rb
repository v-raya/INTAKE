...
describe FerbRoutes do
  ...
  describe '.screening_relationship' do
    it 'returns /screening_relationships/batch' do
      expect(described_class.screening_relationships).to eq('/screening_relationships/batch')
    end
  end
